		...
		if ($_SERVER['REQUEST_METHOD'] == 'POST') {
			...
			if (empty($formErrors)) {
				...
				if ($check == 1) {
					...
					$theMsg = '<div class="alert alert-danger">' . htmlspecialchars('Sorry This User Is Exist', ENT_QUOTES, 'UTF-8') . '</div>';
					...
					$theMsg = "<div class='alert alert-success'>" . htmlspecialchars($stmt->rowCount(), ENT_QUOTES, 'UTF-8') . ' Record Inserted</div>';
			...
			$theMsg = '<div class="alert alert-danger">' . htmlspecialchars('Sorry You Cant Browse This Page Directly', ENT_QUOTES, 'UTF-8') . '</div>';
...
<?php
			...
			$theMsg = '<div class="alert alert-danger">' . htmlspecialchars('Theres No Such ID', ENT_QUOTES, 'UTF-8') . '</div>';
		...
		if ($check > 0) {
			...
			$theMsg = "<div class='alert alert-success'>" . htmlspecialchars($stmt->rowCount(), ENT_QUOTES, 'UTF-8') . ' Record Deleted</div>';

			redirectHome($theMsg, 'back');
		} else {

			$theMsg = '<div class="alert alert-danger">' . htmlspecialchars('This ID is Not Exist', ENT_QUOTES, 'UTF-8') . '</div>';
